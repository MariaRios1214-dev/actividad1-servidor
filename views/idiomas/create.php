...
<body>
    ...
    <form method="POST" action="index.php?controller=idiomas&action=store">
        ...
        <input type="text" name="nombre" required placeholder="Ej: Español, Inglés, Francés"><br><br>

        <label>Código ISO:</label><br>
        <input type="text" name="iso_code" required maxlength="10" placeholder="Ej: ES, EN, FR"><br><br>
